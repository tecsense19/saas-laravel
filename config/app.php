...
return [
    ...
    */
    ...
    'tenancy_central_domains' => env('APP_TENANCY_CENTRAL_DOMAIN', 'localhost'),
    // 'tenancy_central_domains' => env('APP_TENANCY_CENTRAL_DOMAIN', 'localhost,tecsenseinnovations.com'),
