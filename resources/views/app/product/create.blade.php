                                    ...
                                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                        <div class="col-md-6 col-xl-6">
                                            <div class="mb-7">
                                                ...
                                                <div class="mt-1">
                                                    <style>.image-input-placeholder { background-image: url('{{ asset_url("app/media/svg/files/blank-image.svg") }}' ) } [data-bs-theme="dark"] .image-input-placeholder { background-image: url('{{ asset("app/media/svg/files/blank-image-dark.svg") }}'); }</style>
                                    ...
                                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                        <div class="col-md-4 col-xl-4">
                                            <div class="fv-row mb-7">
                                                ...
                                                <x-text-input id="product_name" class="block mt-1 w-full" type="text" name="product_name" :value="old('product_name')" placeholder="Product Name" required />
                                                ...
                                                <select class="form-control mt-1" id="category_id" name="category_id">
                                                    ...
                                                    @if(count($categoryList) > 0)
                                                        @foreach($categoryList as $single)
                                                                <option value="{{ $single->id }}">{{ $single->category_name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                                ...
                                                <select class="form-control mt-1" id="qr_id" name="qr_id">
                                                    ...
                                                    @if(count($qrPointList) > 0)
                                                        @foreach($qrPointList as $single)
                                                                <option value="{{ $single->id }}">{{ $single->qr_amount }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                        ...
                                        <div class="col-md-4 col-xl-4">
                                            <div class="fv-row mb-7">
                                                ...
                                                <x-text-input id="product_price" class="block mt-1 w-full" type="text" name="product_price" :value="old('product_price')" placeholder="Product Price" required />
                                        ...
                                        <div class="col-md-4 col-xl-4">
                                            <div class="fv-row mb-7">
                                                ...
                                                <x-text-input id="distributor_price" class="block mt-1 w-full" type="text" name="distributor_price" :value="old('distributor_price')" placeholder="Distributor Price" required />
                                                ...
                                                <select class="form-control mt-1" id="hsnsac_id" name="hsnsac_id">
                                                    ...
                                                    @if(count($hsnSacList) > 0)
                                                        @foreach($hsnSacList as $single)
                                                                <option value="{{ $single->id }}">{{ $single->hsnsac_name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                                    ...
                                                    @if(count($single->variantOptions) > 0)
                                                        @foreach($single->variantOptions as $keys => $singleOpt)
                                                            @if(strtolower($single->variant_name) != 'colors')
                                                                <div class="col-sm-3 col-xl-3 p-2">
                                                                    <div class="form-check form-check-custom form-check-success form-check-solid">
                                                                        <input class="form-check-input" type="radio" value="{{ $singleOpt->id }}" name="product_variant_options[{{$varKey}}][]" id="flexCheckboxLg_{{$varKey}}_{{ $keys }}" />
                                                            ...
                                                            @else
                                                                <div class="col-sm-3 col-xl-3 p-2">
                                                                    <div class="form-check form-check-custom form-check-success form-check-solid">
                                                                        <input class="form-check-input" type="checkbox" value="{{ $singleOpt->id }}" name="product_variant_options[{{$varKey}}][]" id="flexCheckboxLg_{{$varKey}}_{{ $keys }}" />
                                                                        <label class="form-check-label" for="flexCheckboxLg_{{$varKey}}_{{ $keys }}">
                                                                            {{ $singleOpt->name }}
                                                                        </label>
                                                                    </div>
            ...
            $( document ).ready(function() {
                $("#productForm").validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        submitButton = document.getElementById('productSubmit');
