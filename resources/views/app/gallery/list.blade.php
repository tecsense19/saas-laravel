<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
    ...
    <tbody class="text-gray-600 fw-semibold">
        @if(isset($galleryList) && count($galleryList) > 0)
            @foreach($galleryList as $keys => $singleRec)
                    ...
                    <td class="text-end">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton_{{ $keys }}">
                                ...
                                <li>
                                    <a class="dropdown-item" onclick="deleteGallery('{{ encrypt($singleRec->id) }}')" href="javascript:void(0)">Delete</a>
                                </li>
                            </ul>
                        </div>
                    </td>
        ...
        @else
            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700 text-center">
                <td colspan="10">Gallery list not found.</td>
            </tr>
        @endif
    </tbody>
</table>
{!! $galleryList->links('pagination') !!}