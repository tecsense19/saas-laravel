            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div data-kt-menu-trigger="click" class="menu-item @if(request()->is('tenants') || request()->is('tenants/create')) here show @endif menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <a class="menu-link @if(request()->is('tenants')) active @endif" href="{{ route('tenants.index') }}">
                            <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                            </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link @if(request()->is('tenants/create')) active @endif" href="{{ route('tenants.create') }}">
                            <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                            </span>
