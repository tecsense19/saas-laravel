...
<footer id="footer" class="footer_area bg-black relative z-10">
    <div class="shape absolute left-0 top-0 opacity-5 h-full overflow-hidden w-1/3">
        <img src="{{ asset_url('front/images/footer-shape-left.png') }}" alt="">
    </div>
    <div class="shape absolute right-0 top-0 opacity-5 h-full overflow-hidden w-1/3">
        <img src="{{ asset_url('front/images/footer-shape-right.png') }}" alt="">
    </div>
    <div class="container">
                ...
                <div class="w-full md:w-1/2 lg:w-3/12">
                    <div class="footer_about mt-13 mx-3">
                        <div class="footer_logo">
                            <a href="#"><img src="{{ asset_url('front/images/logo-footer.svg') }}" alt=""></a>
                        </div>
...
<!--====== Tiny Slider js ======-->
<script src="{{ asset_url('front/js/tiny-slider.js') }}"></script>

<!--====== Wow js ======-->
<script src="{{ asset_url('front/js/wow.min.js') }}"></script>

<!--====== Main js ======-->
<script src="{{ asset_url('front/js/main.js') }}"></script>